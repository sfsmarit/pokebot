...
def こうそくスピン(display_log: bool = False) -> bool:
    moves = ["ステルスロック", "まきびし", "どくびし", "ねばねばネット", "やどりぎのタネ", "ほのおのうず"]
...
def test(move: str, display_log: bool = False) -> bool:
    ...
    return "追加効果" in "".join(battle.logger.get_turn_log(turn=battle.turn, idx=0))
