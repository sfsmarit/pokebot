...
def wall_break(display_log: bool = False) -> bool:
    moves = PokeDB.tagged_moves["wall_break"]
...
def test(move: str, display_log: bool = False) -> bool:
    ...
    return "壁破壊" in "".join(battle.logger.get_turn_log(battle.turn, 0))


if __name__ == "__main__":
    print(wall_break(True))
