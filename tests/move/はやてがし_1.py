...
def はやてがえし_1(display_log: bool = False) -> bool:
    max_turn = 1
    ...
    return "技成功" in "".join(battle.logger.get_turn_log(turn=battle.turn, idx=0)) and \
        "ひるみ" in "".join(battle.logger.get_turn_log(turn=battle.turn, idx=1))
