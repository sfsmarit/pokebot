...
def unrepeatable(display_log: bool = False) -> bool:
    moves = PokeDB.tagged_moves["unrepeatable"]
...
def test(move: str, display_log: bool = False) -> bool:
    ...
    return "不発" in "".join(battle.logger.get_turn_log(battle.turn, 0))


if __name__ == "__main__":
    print(unrepeatable(True))
