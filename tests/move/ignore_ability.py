...
def ignore_ability(display_log: bool = False) -> bool:
    result = True
    for move in PokeDB.tagged_moves["ignore_ability"]:
...
def test(move: str, display_log: bool = False) -> bool:
    ...
    return "勝ち" in "".join(battle.logger.get_turn_log(turn=battle.turn, idx=0))


if __name__ == "__main__":
    print(ignore_ability(True))
