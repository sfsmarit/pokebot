from pokebot import Pokemon, Player, PokeDB, Battle
...
def non_negoto(display_log: bool = False) -> bool:
    moves = PokeDB.tagged_moves["non_negoto"]
...
def test(move: str, display_log: bool = False) -> bool:
    ...
    return "技失敗" in battle.logger.get_turn_log(battle.turn, 0)


if __name__ == "__main__":
    print(non_negoto(True))
