...
def ignore_rank(display_log: bool = False) -> bool:
    moves = PokeDB.tagged_moves["ignore_rank"]
...
def test(move: str, display_log: bool = False) -> bool:
    ...
    return "防御ランク" not in battle.logger.get_damage_log(battle.turn, 0)


if __name__ == "__main__":
    print(ignore_rank(True))
