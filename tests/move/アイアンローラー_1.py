...
def アイアンローラー_1(display_log: bool = False) -> bool:
    moves = ["アイアンローラー", "アイススピナー"]
...
def test(move: str, display_log: bool = False) -> bool:
    ...
    return "フィールド消失" in "".join(battle.logger.get_turn_log(turn=battle.turn, idx=0))


if __name__ == "__main__":
    print(アイアンローラー_1(True))
