...
def high_critical(display_log: bool = False) -> bool:
    moves = PokeDB.tagged_moves["high_critical"]
...
def test(move: str, display_log: bool = False) -> bool:
    ...
    return critical_probability(battle, 0, Move(move)) == 0.125


if __name__ == "__main__":
    print(high_critical(True))
