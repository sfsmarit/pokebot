...
def ハドロンエンジン(display_log: bool = False) -> bool:
    max_turn = 1
    ...
    return abilities[0][0] in "".join(battle.logger.get_turn_log(turn=0, idx=0)) and \
        abilities[0][0] in "".join(battle.logger.get_damage_log(turn=1, idx=0))
