...
from .methods.single_hit_damages import _single_hit_damages
from .methods.lethal import lethal
from .methods.attack_type_modifier import _attack_type_modifier
from .methods.defence_type_modifier import _defence_type_modifier
from .methods.power_modifier import _power_modifier
from .methods.attack_modifier import _attack_modifier
from .methods.defence_modifier import _defence_modifier
from .methods.damage_modifier import _damage_modifier
